...
public class OuterUserInfo implements IUserInfo {
    ...
    private IOuterUserOfficeInfo officeInfo = null; // 员工的工作信息
    ...
    public OuterUserInfo(IOuterUserBaseInfo _baseInfo, IOuterUserHomeInfo _homeInfo, IOuterUserOfficeInfo _officeInfo) {
        ...
        this.officeMap = this.officeInfo.getUseOfficeInfo();
    }
    ...
    public String getMobileNumber() {
        String mobileNumber = (String) this.homeMap.get("mobileNumber");
