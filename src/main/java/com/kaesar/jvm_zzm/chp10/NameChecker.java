...
/**
 * 命名检查器，程序名称规范的编译器插件：<br>
 * 如果程序命名不合规范，将会输出一个编译器的WARNING信息
 *
 * @Author: chengk
 * @Date: 2021/5/23 4:32 下午
 */
public class NameChecker {
    ...
    private class NameCheckScanner extends ElementScanner6<Void, Void> {
         ...
         */
        @Override
        public java.lang.Void visitType(TypeElement e, Void p) {
        ...
        public Void visitExecutable(ExecutableElement e, Void p) {
            if (e.getKind() == ElementKind.METHOD) {
                ...
                if (name.contentEquals(e.getEnclosingElement().getSimpleName())) {
                    messager.printMessage(Diagnostic.Kind.WARNING, "一个普通方法'" + name + "'不应当与类名重复，避免与构造函数产生歧义");
                }
        ...
        /**
         * 大写命名检查，要求第一个字母必须是大写的英文字母，其余部门可以是下划线或大写字母
         *
         * @param e
         */
