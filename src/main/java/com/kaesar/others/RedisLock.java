...
public class RedisLock {
     ...
     */
    public RedisLock(RedisTemplate redisTemplate, String lockKey, long expireTime, long timeout) {
    ...
    public boolean tryLock() {
        ...
        // 请求锁超时时间，纳秒
        long overTime = timeout * 1000000;
        // 系统当前时间，纳秒
        long nowTime = System.nanoTime();
        while ((System.nanoTime() - nowTime) < overTime) {
    ...
    public boolean unlock() {
        ...
        if (locked) {
            return (boolean) redisTemplate.execute((RedisCallback<Boolean>) connection -> {
                ...
                if (result == 0) {
                    LOGGER.warn("Redis分布式锁，解锁{}失败！解锁时间：{}", lockKey, System.currentTimeMillis());
                }
